...
var MallTransaction = /** @class */ (function (_super) {
     ...
     */
    MallTransaction.buildForIntegration = function (commerceCode, apiKey) {
        return new MallTransaction(new options_1.default(commerceCode, apiKey, environment_1.default.Integration));
    };
    /**
     ...
     */
    MallTransaction.buildForProduction = function (commerceCode, apiKey) {
        return new MallTransaction(new options_1.default(commerceCode, apiKey, environment_1.default.Production));
    };
    /**
    ...
    MallTransaction.prototype.installments = function (token, details) {
        return __awaiter(this, void 0, void 0, function () {
            var response, _i, details_1, detail, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        detail = details_1[_i];
                        _b = (_a = response).push;
                        return [4 /*yield*/, request_service_1.default.perform(new requests_1.InstallmentsRequest(token, detail.installmentsNumber, detail.commerceCode, detail.buyOrder), this.options)];
                    case 2:
                        _b.apply(_a, [_c.sent()]);
                        _c.label = 3;
                    case 3:
