...
var TransactionDetail = /** @class */ (function () {
    function TransactionDetail(amount, commerceCode, buyOrder, installmentsNumber) {
        if (installmentsNumber === void 0) { installmentsNumber = undefined; }
        this.amount = amount;
        this.commerceCode = commerceCode;
        this.buyOrder = buyOrder;
        this.installmentsNumber = installmentsNumber;
    }
    TransactionDetail.prototype.toPlainObject = function () {
        return {
            amount: this.amount,
